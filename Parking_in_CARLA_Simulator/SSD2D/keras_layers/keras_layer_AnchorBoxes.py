...
class AnchorBoxes(tf.keras.layers.Layer):
    ...
    def call(self, x, mask=None):
        ...
        feature_map_height, feature_map_width, feature_map_channels = int(feature_map_height), int(feature_map_width), int(feature_map_channels)
        ...
        boxes_tensor = tf.tile(tf.keras.backend.constant(boxes_tensor, dtype='float32'), (tf.keras.backend.shape(x)[0], 1, 1, 1, 1))
