...
import cProfile
import numpy as np
from rrt.planner import Planner, DWBPlanner
import cv2
...
class DWBPlanRunner(PlanRunner):
    def __init__(self, file_type='valid', name='dwb-rrt', recall_bar=0.7):
        super(DWBPlanRunner, self).__init__(file_type=file_type, name=name)
